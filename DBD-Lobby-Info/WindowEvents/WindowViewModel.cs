...
namespace DBD_Lobby_Info.WindowEvents
{
    ...
    public class WindowViewModel : INotifyPropertyChanged
    {
        ...
        public const string MISSING_ICON = "https://i.imgur.com/1DGQcGE.png";
        ...
        public SolidColorBrush RankColor { get; set; } = new SolidColorBrush(Colors.White);

        // Sensitive Stuff
        public string Icon1 { get; set; } = MISSING_ICON;
        public string Icon2 { get; set; } = MISSING_ICON;
        public string Icon3 { get; set; } = MISSING_ICON;
        ...
        /// </summary>
        public int FlatBorderThickness => Borderless && mWindow.WindowState != WindowState.Maximized ? 0 : 1;
        ...
        public WindowViewModel(Window window)
        {
            ...
            MaximizeCommand = new RelayCommand((obj) => mWindow.WindowState ^= WindowState.Maximized);
            CloseCommand = new RelayCommand((obj) => mWindow.Close());
            MenuCommand = new RelayCommand((obj) => SystemCommands.ShowSystemMenu(mWindow, GetMousePosition()));
